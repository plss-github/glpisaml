...
class ConfigEntity extends ConfigItem
{
    ...
    public const SAML_ATTR_USERNAME = 'saml_attr_username';
    public const SAML_ATTR_EMAIL = 'saml_attr_email';
    public const SAML_ATTR_FIRSTNAME = 'saml_attr_firstname';
    public const SAML_ATTR_LASTNAME = 'saml_attr_lastname';
    public const SAML_ATTR_REALNAME = 'saml_attr_realname';
